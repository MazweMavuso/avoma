...
const LoginPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    alert('Login feature coming soon! Thank you for testing.');
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors duration-500 pt-32 pb-20 px-4">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
        ...
        >
          <div className="inline-flex items-center space-x-2 bg-orange-50 dark:bg-orange-950/20 px-4 py-2 rounded-full text-orange-600 mb-6">
            <ShieldCheck size={16} />
          ...
          <h1 className="text-4xl sm:text-6xl font-black text-gray-900 dark:text-white uppercase tracking-tighter leading-none mb-6">
            Welcome Back to <span className="text-orange-600">AVOMA</span>
          </h1>
        ...
        >
          ...
          <div className="text-center lg:hidden mb-10">
            ...
            <div className="mt-2 w-12 h-1 bg-orange-600 mx-auto rounded-full"></div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-1">
                ...
                <Link to="/contact" className="text-[10px] font-black uppercase tracking-[0.2em] text-orange-600 hover:underline">
                  Forgot?
                </Link>
              </div>
              <input
            ...
            <div className="flex items-center space-x-2 px-1">
              <input
                ...
                onChange={handleChange}
                className="w-4 h-4 rounded border-gray-300 text-orange-600 focus:ring-orange-600 dark:bg-gray-800 dark:border-gray-700"
              />
            ...
            <div className="pt-4">
              ...
              <p className="mt-8 text-center text-sm text-gray-500 dark:text-gray-500 font-medium">
                ...
                <Link to="/signup" className="text-orange-600 hover:underline font-black uppercase tracking-widest text-[11px]">
                  Join Now
                </Link>
              </p>
            </div>
