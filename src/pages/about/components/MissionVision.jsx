    ...
    <section className="mb-32">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          variants={fadeInUp}
          className="bg-gray-50 dark:bg-gray-900 p-12 rounded-[40px] border border-gray-100 dark:border-gray-800 relative overflow-hidden group hover:border-red-500/30 transition-all duration-500"
        >
          ...
          <div className="absolute top-0 right-0 -mt-8 -mr-8 w-40 h-40 bg-red-600/5 rounded-full blur-3xl group-hover:bg-red-600/10 transition-colors"></div>
        </motion.div>
        ...
        >
          <div className="relative z-10">
            <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center text-red-600 mb-8 shadow-lg shadow-white/10">
              <Eye size={32} />
            </div>
            <h2 className="text-3xl font-black mb-6 tracking-tight">Our Vision</h2>
            <p className="text-lg text-red-100/80 font-medium leading-relaxed">
      ...
      <motion.div 
        ...
        viewport={{ once: true }}
        className="mt-12 p-8 bg-red-50 dark:bg-red-900/10 rounded-[32px] border border-red-100 dark:border-red-900/30 flex flex-col md:flex-row items-center gap-6"
      >
        <div className="flex-shrink-0 w-12 h-12 bg-white dark:bg-gray-800 rounded-xl flex items-center justify-center text-red-600 shadow-sm">
          <ShieldCheck size={24} />
        </div>
